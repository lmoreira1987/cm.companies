...
namespace GServiceManagerMVC.Models
{
    ...
    public partial class StatusAtividade
    {
        public StatusAtividade()
        {
            this.Atividades = new HashSet<Atividade>();
            this.StatusAtividadeExecucaos = new HashSet<StatusAtividadeExecucao>();
        }
        ...
        public virtual ICollection<StatusAtividadeExecucao> StatusAtividadeExecucaos { get; set; }
    }
}
